...
namespace MongoDB.Repository
{
    ...
    public class MongoDBRepository<T1, T2> where T1 : BaseEntity where T2 : BaseEntity
    {
    ...
    public class MongoDBRepository<T1, T2, T3> where T1 : BaseEntity where T2 : BaseEntity where T3 : BaseEntity
    {
        protected readonly IMongoCollection<T1> Context1;
        protected readonly IMongoCollection<T2> Context2;
    ...
    public class MongoDBRepository<T1, T2, T3, T4> where T1 : BaseEntity where T2 : BaseEntity where T3 : BaseEntity where T4 : BaseEntity
    {
        protected readonly IMongoCollection<T1> Context1;
        protected readonly IMongoCollection<T2> Context2;
        protected readonly IMongoCollection<T3> Context3;
    ...
    public class MongoDBRepository<T1, T2, T3, T4,T5> where T1 : BaseEntity where T2 : BaseEntity where T3 : BaseEntity where T4 : BaseEntity where T5 : BaseEntity
    {
        protected readonly IMongoCollection<T1> Context1;
        protected readonly IMongoCollection<T2> Context2;
        protected readonly IMongoCollection<T3> Context3;
